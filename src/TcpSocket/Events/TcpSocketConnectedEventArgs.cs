namespace TcpSocket.Events
{
    ...
    public class TcpSocketConnectedEventArgs : EventArgs
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TcpSocketConnectedEventArgs"/> class.
        /// </summary>
        /// <param name="Source">The source.</param>
        /// <param name="EndPoint">The endpoint.</param>
        /// <param name="Time">The time.</param>
        public TcpSocketConnectedEventArgs(Socket Source, EndPoint EndPoint, DateTime? Time = null)
        {
            if (Source == null)
            {
